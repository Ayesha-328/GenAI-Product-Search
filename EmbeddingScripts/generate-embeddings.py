...
openai.api_key = "your-azure-openai-key"  # Replace with your actual key
...
# Clean columns
exclude_columns = ['links','availability', 'availability_date','tax', 'mpn']
